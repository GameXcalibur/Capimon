                    ...
                    <div class="card-body">
                        <form action="{{ route('product-categories.update', $category->id) }}" method="POST">
                            ...
                            <div class="form-group">
                                <label class="font-weight-bold" for="category_code">Site Code <span class="text-danger">*</span></label>
                                <input class="form-control" type="text" name="category_code" required value="{{ $category->category_code }}">
                            </div>
                            <div class="form-group">
                                <label class="font-weight-bold" for="category_name">Site Name <span class="text-danger">*</span></label>
